...
| `torrey_pines_noaa_summary.csv` | Final NOAA buoy metrics |
| `torrey_pines_noaa_best_pinn_by_lead.csv` | Best physics-regularizer weights for each NOAA buoy lead time |
